...
export default function BookingMenu({ position }) {
  ...
  const adaptPosition = position ? 'static' : 'fixed';
...
/*  function handleBooking() {
  ...
  return (
    <section className={styles.bookingMenuBackground} style={{ position: adaptPosition }}>
      <div className={styles.bookingMenuDiv} style={{ position: adaptPosition }}>
